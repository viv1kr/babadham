...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      <header className={`w-full font-sans select-none overflow-visible relative z-40`}>
      ...
      >
        ...
        <a href="#" className="flex flex-col items-center justify-center group relative z-10" aria-label="Company Logo Home">
          <img 
      ...
      <div className="w-full bg-[#120508] sticky top-0 z-[999]">
        <nav className={`w-full font-sans transition-all duration-300 ${
          isScrolled 
            ? 'bg-[#FFF8F0]/95 backdrop-blur-md py-2' 
            : 'bg-[#FFF8F0] py-2.5 sm:py-3'
        }`}>
