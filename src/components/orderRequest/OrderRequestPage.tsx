            ...
            <div>
              ...
              {step === 1 ? (
                ...
                >
                  ...
                  <div className="flex items-center mb-4 ml-1 bg-white/60 backdrop-blur-md p-0.5 border border-[#E8E1D5]/80 shadow-[0_4px_12px_rgba(0,0,0,0.03)] w-fit self-start">
                    <button 
                      type="button"
                      onClick={() => setLang('hi')}
                      className={`relative px-3 py-1 text-[11px] sm:text-xs font-bold transition-all duration-300 ${lang === 'hi' ? 'text-[#500A18] shadow-[0_2px_8px_rgba(0,0,0,0.06)]' : 'text-gray-400 hover:text-gray-600'}`}
                    >
                    ...
                    <button 
                      type="button"
                      onClick={() => setLang('en')}
                      className={`relative px-3 py-1 text-[11px] sm:text-xs font-bold transition-all duration-300 ${lang === 'en' ? 'text-[#500A18] shadow-[0_2px_8px_rgba(0,0,0,0.06)]' : 'text-gray-400 hover:text-gray-600'}`}
                    >
