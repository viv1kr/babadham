...
export const VENDORS_DATA: any[] = [
  {
    id: 'vnd-1',
    name: 'Deoghar Goshala Cooperative',
    contactPerson: 'Pandit Rameshwar Jha',
    phone: '+91 98351 22910',
    email: 'goshala@babadham.org',
    address: 'Baidyanath Dham Goshala Marg, Deoghar',
    category: 'Pure Ghee & Prasad',
    status: 'Active',
    createdAt: '2026-01-15'
  },
  {
    id: 'vnd-2',
    name: 'Sultanganj Ganga Samiti',
    contactPerson: 'Manoj Kumar Gupta',
    phone: '+91 94312 88102',
    email: 'gangajal@sultanganj.org',
    address: 'Ajgaibinath Ghat, Sultanganj, Bihar',
    category: 'Holy Water (Gangajal)',
    status: 'Active',
    createdAt: '2026-02-01'
  },
  {
    id: 'vnd-3',
    name: 'Varanasi Silk Weaver Union',
    contactPerson: 'Kashi Nath Weaver',
    phone: '+91 97920 44109',
    email: 'weavers@kashisilk.in',
    address: 'Chowk Weaver Colony, Varanasi',
    category: 'Holy Clothes & Angavastram',
    status: 'Active',
    createdAt: '2026-02-10'
  },
  {
    id: 'vnd-4',
    name: 'Nepal Rudraksha Sangam',
    contactPerson: 'Guru Pasang Sherpa',
    phone: '+977 98412 33901',
    email: 'contact@nepalrudraksh.org',
    address: 'Pashupatinath Marg, Kathmandu',
    category: 'Sacred Beads & Malas',
    status: 'Active',
